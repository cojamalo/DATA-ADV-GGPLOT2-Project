---
title: "Recreating the Economist Visualizaion"
output: 
    html_document:
        toc: true
---
...
## Reference plot
The goal of this project is to demonstrate plotting skills in R to recreate the following professional plot that appeared in The Economist magazine. Everything is done from scratch using `ggplot2`:
![Source plot to recreate.](/Users/cojamalo/Documents/DATA-Udemy- Data-Viz/Economist1.png)
<br>
...
Other miscellaneous changes had to be made to the data since the source data was not labeled the exact same as the Economist plot:
```{r}
...
* The correct font is missing. The Economist uses a different font than the default font used in ggplot. If the exact name of the font was known, it could be possible to fix this.
...
* It is clear that the supplied data is not exactly the same as what the Economist used, or they edited their data in an unknown way. Miscellaneous data errors and region classifications remain in the recreation compared to the reference plot.
